package com.example.cugcsc.tool.download;

import android.os.Handler;


import com.example.cugcsc.tool.CustomHttpClient;
import com.example.cugcsc.tool.download.listener.OnDownloadProgressListener;
